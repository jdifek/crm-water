          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-gray-100">
                <th className="border px-4 py-2 text-left sticky left-0 bg-gray-100">
                  ID
                </th>
                <th className="border px-4 py-2 text-left sticky left-10 bg-gray-100">
                  Торгова точка
                </th>
                <th className="border px-4 py-2 text-left sticky left-40 bg-gray-100">
                  Серійний номер
                </th>
                ...
                item.rows.map((row, rowIndex) => (
                  <tr key={`${itemIndex}-${rowIndex}`}>
                    {rowIndex === 0 && (
                      <>
                        <td
                          className="border px-4 py-2 sticky left-0 bg-white"
                          rowSpan={3}
                        >
                          {item.id}
                        </td>
                        <td
                          className="border px-4 py-2 sticky left-10 bg-white"
                          rowSpan={3}
                        >
                          {item.location}
                        </td>
                        <td
                          className="border px-4 py-2 sticky left-40 bg-white"
                          rowSpan={3}
                        >
                          {item.serial}
                        </td>
